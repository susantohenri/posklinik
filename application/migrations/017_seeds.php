...
class Migration_seeds extends CI_Migration {
  ...
  function up () {
    ...
    foreach (array('User', 'Role', 'Permission', 'Menu', 'Pasien', 'Layanan', 'Obat', 'Penjualan', 'PenjualanLayanan', 'PenjualanObat', 'Dokter', 'Staff', 'PenjualanLainLain', 'JenisKartu', 'AsalPasien', 'KategoriLayanan'/*additionalEntity*/) as $entity)
    {
