...
class Migration_seeds extends CI_Migration {
  ...
  function up () {
    ...
    foreach (array('User', 'Role', 'Permission', 'Pasien', 'Layanan', 'Obat', 'Penjualan', 'PenjualanLayanan', 'PenjualanObat', 'Pembayaran', 'Dokter', 'PenjualanJasaDokter', 'Staff', 'PenjualanLainLain'/*additionalEntity*/) as $entity)
    {
